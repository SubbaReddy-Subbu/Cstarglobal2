...
const Navbar = () => {
  return (
    <div className="flex w-[100%] bg-orange-300">
      {/* <div className="flex w-[80%] mx-auto justify-between">
        <a href="/#">
          <img
            src="https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcTGgcOHT9fwQ2DsbKfEwu13K8BVXTsDUWV9ofyq1WBvEEpMEtrp"
            className="w-[40px] h-10 rounded m-2"
            alt=""
          />
        </a>
        <div className="m-2">
